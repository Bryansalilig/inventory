...
{
  public function __construct(public int $id, public string $user_name, public string $asset_tag, public string $employee_name, public string $quantity, public string $created_at, public string $action) {}

  public static function fromModel(StockHistory $shistory): self
  {
    return new self(id: $shistory->id, user_name: 'Bryan Salilig', asset_tag: $shistory->asset_tag, employee_name: $shistory->employee_name, quantity: $shistory->quantity, created_at: $shistory->created_at, action: $shistory->action);
  }
