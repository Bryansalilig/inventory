            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <select class="form-control form-control-sm @error('asset_tag') is-invalid @enderror" name="asset_tag" required>
                  ...
                  <option value="ESSC-Keyboard">ESSC-Keyboard</option>
                  <option value="ESSC-Monitor">ESSC-Monitor</option>
                  <option value="ESSC-Mouse">ESSC-Mouse</option>
                  <option value="ESSC-Headset">ESSC-Headset</option>
                  <option value="ESSC-UPS">ESSC-UPS</option>
                </select>
